...
func _ready() -> void:
	...
	frame_style.border_color = Color(0, 0, 0)
...
func _make_button(label_text: String) -> Button:
	...
	if ResourceLoader.exists(BUTTON_IMAGE):
		...
		style.border_color = Color(0.0, 0.357, 0.137, 0.702)
		...
		btn.add_theme_color_override("font_color", Color(0.0, 0.37, 0.143, 1.0))
	return btn
func _make_arrow_button(label_text: String) -> Button:
	...
	if ResourceLoader.exists(BUTTON_IMAGE):
		...
		var style = StyleBoxFlat.new()
		style.bg_color = Color(0.15, 0.15, 0.22)
		style.border_color = Color(0.0, 0.586, 0.244, 0.702)
		style.set_border_width_all(2)
		style.set_corner_radius_all(12)
		btn.add_theme_stylebox_override("normal", style)
		btn.add_theme_stylebox_override("hover", style)
		btn.add_theme_stylebox_override("pressed", style)
		btn.add_theme_font_size_override("font_size", 32)
		btn.add_theme_color_override("font_color", Color(0.0, 0.481, 0.195, 1.0))
	return btn
